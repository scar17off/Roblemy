...
function boxBase:Update()
    ...
    if ESP.Highlighted == self.Object then
       color = ESP.HighlightColor
        ...
        color = self.Color or self.ColorDynamic and self:ColorDynamic() or ESP:GetColor(self.Object) or ESP.BoxColor
    end
    ...
    if ESP.Boxes then
        ...
        if self.Components.Quad then
            if Vis1 or Vis2 or Vis3 or Vis4 then
                ...
                self.Components.Quad.Color = ESP.BoxColor
            else
    ...
    if ESP.Name then
        ...
        if Vis5 then
            ...
            self.Components.Name.Color = ESP.NameColor
        else
    ...
    if ESP.Distances then
        ...
        if Vis5 then
            ...
            self.Components.Distance.Color = ESP.DistancesColor
        else
    ...
    if ESP.Health then
        ...
        if Vis5 then
            ...
            self.Components.Health.Color = ESP.HealthColor
        else
...
for i,v in pairs(plrs:GetPlayers()) do
    if ESP.LocalPlayer then
        PlayerAdded(v)
    elseif ESP.LocalPlayer ~= true then
        if v ~= plr then
            PlayerAdded(v)
        end
    end
